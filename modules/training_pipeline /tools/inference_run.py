...
from training_pipeline_ import configs
...
def infer(
    ...
    from training_pipeline_ import initialize

    # Be sure to initialize the environment variables before importing any other modules.
    initialize(logging_config_path=logging_config_path, env_file_path=env_file_path)

    from training_pipeline_ import utils
    from training_pipeline_.api import InferenceAPI
